...
import com.webrtc.member.service.LoginService;
import com.webrtc.member.service.MemberService;
import com.webrtc.util.JWTUtil;
import com.webrtc.util.KakaoOAuth2Util;
...
//    }
    ...
    public ResponseEntity<Map<String, String>> kakaoCallback(@RequestParam("code") String code) {
        ...
        params.add("client_id", "8327d68228a934423bed1bd4436581fd");
        ...
        try {
            MemberDTO kakaoMember = MemberDTO.builder()
                    ...
                    .member_email(email)
                    .member_created_date(LocalDateTime.now())
//                    .member_delete_yn(0)
//                    .member_last_login(LocalDateTime.now())
